...
//        pamount=t1.toString();
        ...
        e3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Usermakepayment.this,
        ...
        e4.setText(Viewvaccinebooking.amts);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(name.equalsIgnoreCase("") )
                {
                    ...
                    JR1.json_response=(JsonResponse) Usermakepayment.this;
                    String q1 = "/usermakepayment?book_id=" + Viewvaccinebooking.bid+"&amts="+Viewvaccinebooking.amts;
                    q1=q1.replace(" ","%20");
                    JR1.execute(q1);
